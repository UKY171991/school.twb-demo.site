...
@section('content')
    <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" rows="3" 
                                              ...
                                              placeholder="Enter class description, curriculum details, or special notes...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @error('status')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">Set the initial status of this class</small>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card grade-card">
                <div class="card-header">
                    <h5 class="card-title"><i class="fas fa-history"></i> Recent Classes</h5>
                </div>
                <div class="card-body">
                    <div class="recent-grades">
                        <div class="recent-grade-item">
                            <div class="grade-badge grade-1">C1</div>
                        ...
                        <div class="recent-grade-item">
                            <div class="grade-badge grade-2">C2</div>
                            <div class="grade-info">
                        ...
                        <div class="recent-grade-item">
                            <div class="grade-badge grade-3">C3</div>
                            <div class="grade-info">
