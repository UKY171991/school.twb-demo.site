                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="2" 
                                  ...
                                  placeholder="Enter class description...">{{ old('description', $grade->description) }}</textarea>
                        @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="grade-color-selector">
                            @for($i = 1; $i <= 12; $i++)
                                <div class="color-option grade-{{ $i }} {{ old('grade_theme', $grade->grade_theme ?? 1) == $i ? 'selected' : '' }}" data-grade="{{ $i }}" title="Class {{ $i }}">
                                    {{ $i }}
                                </div>
                            @endfor
                        </div>
