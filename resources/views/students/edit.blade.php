                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="father_name" class="form-control @error('father_name') is-invalid @enderror" 
                                   id="father_name" placeholder="Enter father's name" value="{{ old('father_name', $student->father_name) }}">
                            @error('father_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="mother_name" class="form-control @error('mother_name') is-invalid @enderror" 
                                   id="mother_name" placeholder="Enter mother's name" value="{{ old('mother_name', $student->mother_name) }}">
                            @error('mother_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
