...
<ul class="space-y-2">
    <li>
        <a href="{{ route('superadmin.dashboard') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 rounded-lg">
    ...
    <li>
        <a href="{{ route('superadmin.schools.index') }}" class="flex items-center px-4 py-3 text-white bg-purple-600 rounded-lg">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <li>
        <a href="{{ route('superadmin.users.index') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 rounded-lg">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
