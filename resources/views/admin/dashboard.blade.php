...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
    <div class="glass-card rounded-2xl p-5 flex items-center space-x-4 border border-slate-100">
        ...
        <div>
            ...
            <h4 class="text-xl font-black text-slate-700">{{ $stats['classrooms'] }}</h4>
        </div>
    </div>
    <div class="glass-card rounded-2xl p-5 flex items-center space-x-4 border border-slate-100">
        <div class="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400">
        ...
        <div>
            ...
            <h4 class="text-xl font-black text-slate-700">{{ $stats['enrollments'] }}</h4>
        </div>
    </div>
    <div class="glass-card rounded-2xl p-5 flex items-center space-x-4 border border-slate-100">
        <div class="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400">
        ...
        <div>
            ...
            <h4 class="text-xl font-black text-slate-700">{{ $stats['grades'] }}</h4>
        </div>
    </div>
</div>
