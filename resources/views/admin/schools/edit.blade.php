...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('admin.schools.update', $school) }}" class="p-6" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="level" id="level" required
                            ...
                            <option value="elementary" {{ old('level', $school->level) == 'elementary' ? 'selected' : '' }}>Elementary</option>
                            <option value="middle" {{ old('level', $school->level) == 'middle' ? 'selected' : '' }}>Middle School</option>
                            <option value="high" {{ old('level', $school->level) == 'high' ? 'selected' : '' }}>High School</option>
                            <option value="k12" {{ old('level', $school->level) == 'k12' ? 'selected' : '' }}>K-12</option>
                            <option value="university" {{ old('level', $school->level) == 'university' ? 'selected' : '' }}>University</option>
                        </select>
                        @error('level')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('description', $school->description) }}</textarea>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        @if($school->principal_signature)
                            <div class="mb-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <img src="{{ asset('storage/' . $school->principal_signature) }}" alt="Current Principal Signature" class="h-16 border rounded shadow-sm">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        @if($school->logo)
                            <div class="mb-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <img src="{{ asset('storage/' . $school->logo) }}" alt="Current School Logo" class="h-20 border rounded shadow-sm">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <input type="date" name="established_date" id="established_date" value="{{ old('established_date', $school->established_date?->format('Y-m-d')) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="student_capacity" id="student_capacity" value="{{ old('student_capacity', $school->student_capacity) }}" min="1"
            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $school->postal_code) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    <div>
