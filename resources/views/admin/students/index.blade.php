        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-primary btn-sm" id="add-student-btn">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="student-modal-label">Add New Student</h5>
            ...
            <form id="student-form">
                @csrf
                <input type="hidden" name="_method" id="student-form-method" value="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="class_id" name="class_id" style="width: 100%;" required>
...
<script>
    $(document).ready(function() {
        ...
        $('#add-student-btn').on('click', function() {
            ...
            $('#student-form').attr('action', "{{ route('admin.students.store') }}");
        ...
        $('#school_id').on('change', function() {
            ...
            if (schoolId) {
                $.ajax({
                    url: '/admin/schools/' + schoolId + '/classes',
                    type: 'GET',
        ...
        $('#students-table').on('click', '.edit-btn', function() {
            var id = $(this).data('id');
            $.get("{{ url('/admin/students') }}" + '/' + id + '/edit', function(data) {
                $('#student-modal-label').text('Edit Student');
                $('#student-form-method').val('PUT');
                $('#student-form').attr('action', "{{ url('/admin/students') }}" + '/' + id);
