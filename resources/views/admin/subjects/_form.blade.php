        ...
        <div class="form-group">
            ...
            <select class="form-control select2" id="school_id" name="school_id" required>
                ...
                @foreach($schools as $school)
                    <option value="{{ $school->id }}" {{ (isset($subject) && $subject->school_id == $school->id) ? 'selected' : '' }}>
                        {{ $school->name }}
                    </option>
                @endforeach
            </select>
...
<div class="form-group">
    ...
    <input type="number" class="form-control" id="credits" name="credits" value="{{ old('credits', $subject->credits ?? '') }}" required min="1">
</div>
...
<div class="form-group">
    <div class="custom-control custom-switch">
        ...
        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', isset($subject) && $subject->is_active) ? 'checked' : '' }}>
