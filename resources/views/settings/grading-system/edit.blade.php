...
@section('content_header')
    <h1>Edit Grade: {{ $gradingSystem->grade }}</h1>
@stop
...
<div class="card">
    ...
    <form action="{{ route('grading-systems.update', $gradingSystem) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="grade" id="grade" class="form-control @error('grade') is-invalid @enderror" 
                               value="{{ old('grade', $gradingSystem->grade) }}" placeholder="e.g., A+, B, C" required>
                        @error('grade')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                               value="{{ old('name', $gradingSystem->name) }}" placeholder="e.g., Excellent, Good, Average" required>
                        @error('name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="min_percentage" id="min_percentage" 
                               ...
                               value="{{ old('min_percentage', $gradingSystem->min_percentage) }}" min="0" max="100" step="0.01" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="max_percentage" id="max_percentage" 
                               ...
                               value="{{ old('max_percentage', $gradingSystem->max_percentage) }}" min="0" max="100" step="0.01" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="grade_points" id="grade_points" 
                               ...
                               value="{{ old('grade_points', $gradingSystem->grade_points) }}" min="0" max="10" step="0.01">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="sort_order" id="sort_order" 
                               ...
                               value="{{ old('sort_order', $gradingSystem->sort_order) }}" min="0">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                          rows="3" placeholder="Optional description for this grade">{{ old('description', $gradingSystem->description) }}</textarea>
                @error('description')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="is_passing" name="is_passing" value="1" 
                               {{ old('is_passing', $gradingSystem->is_passing) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" 
                               {{ old('is_active', $gradingSystem->is_active) ? 'checked' : '' }}>
