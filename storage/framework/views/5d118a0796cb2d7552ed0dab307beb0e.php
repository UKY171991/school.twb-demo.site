...
<div class="table-container">
    <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-white/50">
        <h3 class="card-title">Teaching Staff <span class="ml-2 px-2.5 py-0.5 bg-emerald-50 text-emerald-600 rounded-full text-xs font-bold"><?php echo e($teachers->total()); ?></span></h3>
    </div>
                ...
                <tr>
                    <td>
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="font-bold text-slate-800"><?php echo e($teacher->user->name); ?></div>
                                <div class="text-xs text-slate-400 font-medium"><?php echo e($teacher->user->email); ?></div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <span class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold"><?php echo e($teacher->employee_id); ?></span>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="text-xs text-slate-500 font-medium max-w-[200px] leading-relaxed italic">
                            "<?php echo e(Str::limit($teacher->bio ?? 'No bio available', 60)); ?>"
                        </div>
                    </td>
                    <td>
