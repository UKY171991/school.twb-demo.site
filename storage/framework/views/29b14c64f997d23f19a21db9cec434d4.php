...
<div class="table-container">
    <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-white/50">
        <h3 class="card-title">Enrolled Students <span class="ml-2 px-2.5 py-0.5 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold"><?php echo e($students->total()); ?></span></h3>
    </div>
        ...
        <table class="table-premium">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold"><?php echo e($student->student_id); ?></span>
                    </td>
                    <td>
                        <div class="text-sm font-semibold text-slate-700"><?php echo e($student->phone ?? 'N/A'); ?></div>
                        <div class="text-xs text-slate-400 font-medium truncate max-w-[200px]"><?php echo e($student->address ?? 'No address'); ?></div>
                    </td>
                    <td>
                    ...
                    <td class="text-right">
                        <div class="flex items-center justify-end space-x-2">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.students.destroy', $student)); ?>" 
                                  class="confirm-action inline" data-confirm="Are you sure you want to delete this student?">
