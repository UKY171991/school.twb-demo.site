...
<?php $__env->startSection('title', 'Student Fees'); ?>
<?php $__env->startSection('page-title', 'Revenue Management'); ?>
...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('admin.fees.create')); ?>" class="btn-primary" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);">
        ...
        <div class="glass-card p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-black text-slate-800 tracking-tight">₹<?php echo e(number_format($fees->where('status', 'paid')->sum('amount'), 2)); ?></h3>
                </div>
            </div>
        </div>
        <div class="glass-card p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-black text-slate-800 tracking-tight">₹<?php echo e(number_format($fees->where('status', 'pending')->sum('amount'), 2)); ?></h3>
                </div>
            </div>
        </div>
        <div class="glass-card p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-black text-slate-800 tracking-tight"><?php echo e($fees->where('status', 'paid')->count()); ?></h3>
                </div>
            </div>
        </div>
        <div class="glass-card p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-black text-slate-800 tracking-tight"><?php echo e($fees->unique('student_id')->count()); ?></h3>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="px-8 py-6">
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 rounded-2xl gradient-secondary flex items-center justify-center text-white font-black text-lg shadow-lg shadow-blue-100">
                                    <?php echo e(substr($fee->student?->user?->name, 0, 1)); ?>

                                </div>
                                <div>
                                    <div class="font-black text-slate-800 tracking-tight"><?php echo e($fee->student?->user?->name); ?></div>
                                    <div class="text-xs font-bold text-slate-400 uppercase tracking-tighter"><?php echo e($fee->student?->student_id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-6">
                            <span class="px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black uppercase tracking-widest border border-blue-100"><?php echo e($fee->fee_type); ?></span>
                        </td>
                        <td class="px-6 py-6 text-center italic text-sm font-medium text-slate-400">
                            <?php echo e($fee->month); ?> <?php echo e($fee->year); ?>

                        </td>
                        <td class="px-6 py-6">
                            <div class="font-black text-slate-800">₹<?php echo e(number_format($fee->amount, 2)); ?></div>
                        </td>
                        ...
                        <td class="px-8 py-6 text-right">
                            <div class="flex items-center justify-end space-x-2">
                                <form action="<?php echo e(route('admin.fees.destroy', $fee)); ?>" method="POST" class="confirm-action inline" data-confirm="Delete this fee record?">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\git\school.twb-demo.site\resources\views/admin/fees/index.blade.php ENDPATH**/ ?>