...
<?php $__env->startSection('page-title', 'Academic Curriculum'); ?>
...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('admin.subjects.create')); ?>" class="btn-primary" style="background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%);">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        <div class="glass-card rounded-[2.5rem] overflow-hidden shadow-2xl shadow-purple-100/40 border border-white hover:-translate-y-2 transition-all duration-500 group">
            <div class="p-8">
                ...
                <!-- Info -->
                <h3 class="text-xl font-black text-slate-800 tracking-tight mb-2 uppercase"><?php echo e($subject->name); ?></h3>
                <p class="text-sm font-medium text-slate-400 line-clamp-2 min-h-[40px]"><?php echo e($subject->description ?? 'Comprehensive academic course curriculum.'); ?></p>
                ...
                <div class="mt-8 flex items-center justify-between">
                    <div class="flex flex-col">
                        ...
                        ?>
                        <span class="text-sm font-black text-slate-700 tracking-tighter"><?php echo e($classroomCount); ?> Rooms</span>
            ...
            <div class="px-8 py-5 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between">
                <a href="<?php echo e(route('admin.subjects.edit', $subject)); ?>" class="text-xs font-black text-slate-400 uppercase tracking-widest hover:text-purple-600 transition-colors">Edit File</a>
                
                <form method="POST" action="<?php echo e(route('admin.subjects.destroy', $subject)); ?>" class="confirm-action" data-confirm="Erase path '<?php echo e($subject->name); ?>' from curriculum?">
