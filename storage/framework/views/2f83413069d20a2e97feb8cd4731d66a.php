    ...
    <div class="min-h-screen flex">
        ...
        <aside id="sidebar" class="w-72 bg-slate-900 text-slate-400 flex-shrink-0 flex flex-col transition-all duration-300 fixed lg:relative z-40 h-full lg:h-auto -translate-x-full lg:translate-x-0">
            ...
            <nav class="flex-1 mt-6 px-4 space-y-1 sidebar-scroll overflow-y-auto">
                ...
                <div class="pt-6">
                    ...
                    <a href="<?php echo e(route('admin.marksheets')); ?>" 
                       class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.marksheets*') ? 'sidebar-item-active' : 'hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.marksheets*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <span class="font-semibold">Marksheets</span>
                    </a>

                    <a href="<?php echo e(route('admin.idcards')); ?>" 
                       class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.idcards*') ? 'sidebar-item-active' : 'hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.idcards*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-6">
                    ...
                    <a href="<?php echo e(route('admin.salaries')); ?>" 
                       class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.salaries*') ? 'sidebar-item-active' : 'hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.salaries*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.fees')); ?>" 
                       class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.fees*') ? 'sidebar-item-active' : 'hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.fees*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-6 pb-8">
                    ...
                    <a href="<?php echo e(route('admin.timetables.exam')); ?>" 
                       class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.timetables.exam*') ? 'sidebar-item-active' : 'hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.timetables.exam*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <span class="font-semibold">Exam Schedule</span>
                    </a>

                    <a href="<?php echo e(route('admin.timetables.class')); ?>" 
                       class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('admin.timetables.class*') ? 'sidebar-item-active' : 'hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.timetables.class*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-50 relative">
            ...
            <header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 flex items-center justify-between px-8">
                ...
                <form action="<?php echo e(route('admin.search')); ?>" method="GET" class="flex-1 max-w-md mx-12 hidden md:block">
                    <div class="relative group">
                        ...
                        <input type="text" name="query" value="<?php echo e($query ?? ''); ?>" placeholder="Search students, teachers, schools..." 
