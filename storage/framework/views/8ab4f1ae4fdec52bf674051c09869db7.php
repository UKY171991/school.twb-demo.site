...
<?php $__env->startSection('page-title', 'Modify Faculty Profile'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-5xl mx-auto">
    <!-- Breadcrumbs -->
    <div class="flex items-center space-x-2 text-xs font-bold uppercase tracking-widest text-slate-400 mb-6">
        <a href="<?php echo e(route('admin.teachers')); ?>" class="hover:text-emerald-600 transition-colors">Faculty</a>
    ...
    <div class="glass-card rounded-3xl overflow-hidden shadow-2xl shadow-emerald-100/50">
        <div class="px-10 py-8 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-400 font-medium">Updating records for <strong><?php echo e($teacher->user->name); ?></strong></p>
            </div>
        ...
        <form method="POST" action="<?php echo e(route('admin.teachers.update', $teacher)); ?>" class="p-10">
            <?php echo csrf_field(); ?>
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $teacher->user->name)); ?>" required
                        ...
                        <div>
                            ...
                            <input type="text" name="employee_id" value="<?php echo e(old('employee_id', $teacher->employee_id)); ?>" required
                        ...
                        <div>
                            ...
                            <input type="text" name="department" value="<?php echo e(old('department', $teacher->department)); ?>"
                                   class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-medium text-slate-700">
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email', $teacher->user->email)); ?>" required
                                   class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-medium text-slate-700">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="bio" rows="4" 
                                      class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-medium text-slate-700"><?php echo e(old('bio', $teacher->bio)); ?></textarea>
                        </div>
            ...
            <div class="mt-12 pt-8 border-t border-slate-100 flex items-center justify-end space-x-4">
                <a href="<?php echo e(route('admin.teachers')); ?>" class="btn-secondary">
                    Cancel
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\git\school.twb-demo.site\resources\views/admin/teachers/edit.blade.php ENDPATH**/ ?>