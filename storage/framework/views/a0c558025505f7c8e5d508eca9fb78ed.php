            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="prose max-w-none">
                    ...
                    <div class="bg-blue-50 p-6 rounded-lg">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">
                            Contact Us
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\git\school.twb-demo.site\resources\views/about.blade.php ENDPATH**/ ?>