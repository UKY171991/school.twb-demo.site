...
<?php $__env->startSection('page-title', 'Add New School'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form method="POST" action="<?php echo e(route('admin.schools.store')); ?>" class="p-6" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="public" <?php echo e(old('type') == 'public' ? 'selected' : ''); ?>>Public</option>
                            <option value="private" <?php echo e(old('type') == 'private' ? 'selected' : ''); ?>>Private</option>
                            <option value="charter" <?php echo e(old('type') == 'charter' ? 'selected' : ''); ?>>Charter</option>
                            <option value="international" <?php echo e(old('type') == 'international' ? 'selected' : ''); ?>>International</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="elementary" <?php echo e(old('level') == 'elementary' ? 'selected' : ''); ?>>Elementary</option>
                            <option value="middle" <?php echo e(old('level') == 'middle' ? 'selected' : ''); ?>>Middle School</option>
                            <option value="high" <?php echo e(old('level') == 'high' ? 'selected' : ''); ?>>High School</option>
                            <option value="k12" <?php echo e(old('level') == 'k12' ? 'selected' : ''); ?>>K-12</option>
                            <option value="university" <?php echo e(old('level') == 'university' ? 'selected' : ''); ?>>University</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"><?php echo e(old('description')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="principal_name" id="principal_name" value="<?php echo e(old('principal_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="established_date" id="established_date" value="<?php echo e(old('established_date')); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="student_capacity" id="student_capacity" value="<?php echo e(old('student_capacity')); ?>" min="1"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\git\school.twb-demo.site\resources\views/admin/schools/create.blade.php ENDPATH**/ ?>