...
<?php $__env->startSection('title', 'Class Timetable'); ?>
<?php $__env->startSection('page-title', 'Weekly Schedule'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="glass-card p-8 rounded-[2rem] shadow-xl sticky top-8 border border-white">
                ...
                <form method="POST" action="<?php echo e(route('admin.timetables.class.store')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                ...
                <table class="table-premium w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/20 transition-colors">
                            <td class="px-8 py-6">
                                <div class="font-black text-slate-800 tracking-tight uppercase text-xs"><?php echo e($timetable->day_of_week); ?></div>
                                <div class="text-[10px] font-bold text-blue-500 uppercase tracking-wider mt-1"><?php echo e(date('H:i', strtotime($timetable->start_time))); ?> - <?php echo e(date('H:i', strtotime($timetable->end_time))); ?></div>
                            </td>
                            <td class="px-6 py-6 font-bold text-slate-700">
                                <div class="text-sm"><?php echo e($timetable->subject?->name); ?></div>
                                <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5"><?php echo e($timetable->classroom?->name); ?></div>
                            </td>
                            <td class="px-6 py-6">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center font-black text-xs">
                                        <?php echo e(substr($timetable->teacher?->user?->name, 0, 1)); ?>

                                    </div>
                                    <div class="text-xs font-bold text-slate-600 truncate max-w-[120px]"><?php echo e($timetable->teacher?->user?->name); ?></div>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\git\school.twb-demo.site\resources\views/admin/timetables/class.blade.php ENDPATH**/ ?>