...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="glass-card rounded-2xl overflow-hidden group hover:translate-y-[-4px] transition-all duration-300">
        <div class="h-24 gradient-primary relative">
            <div class="absolute -bottom-10 left-6">
                <?php if($school->logo): ?>
                    <img src="<?php echo e(asset('storage/' . $school->logo)); ?>" alt="<?php echo e($school->name); ?> Logo" class="w-20 h-20 object-cover rounded-2xl border-4 border-white shadow-lg shadow-indigo-100">
                <?php else: ?>
            ...
            <div class="absolute top-4 right-6 flex gap-2">
                <span class="badge-premium <?php echo e($school->is_active ? 'badge-success' : 'badge-danger'); ?>">
        ...
        <div class="pt-14 p-6">
            <div class="mb-4">
                <h3 class="text-xl font-bold text-slate-800 group-hover:text-indigo-600 transition-colors"><?php echo e($school->name); ?></h3>
                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">CODE: <?php echo e($school->code); ?></p>
            </div>
            
            <p class="text-slate-500 text-sm font-medium mb-6 line-clamp-2 leading-relaxed"><?php echo e($school->description ?? 'No description available for this institution.'); ?></p>
            ...
            <div class="space-y-3 mb-8">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="bg-slate-50 rounded-xl p-3">
                        ...
                        <p class="text-xs font-bold text-slate-700"><?php echo e(ucfirst($school->type)); ?></p>
                    </div>
                    <div class="bg-indigo-50/50 rounded-xl p-3">
                        ...
                        <p class="text-xs font-bold text-indigo-700"><?php echo e(number_format($school->student_capacity)); ?></p>
                    </div>
                </div>
            </div>
            
            <div class="flex items-center justify-between pt-5 border-t border-slate-100 mt-auto">
                <span class="text-[11px] font-black text-slate-400 uppercase tracking-widest"><?php echo e(ucfirst($school->level)); ?> LEVEL</span>
    ...
    <div class="col-span-full py-20 text-center">
        ...
        <a href="<?php echo e(route('admin.schools.create')); ?>" class="btn-premium">
